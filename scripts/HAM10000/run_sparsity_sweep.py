...
Issue 9 : warmup_epochs=0 in the dense phase (Setting A, diagnostic confirmed;
          see results/HAM10000/diagnostic_warmup/comparison.md).
...
Output tree
───────────
  results/HAM10000/sparsity_sweep/
...
──────────────────────────
  ...
  python scripts/HAM10000/run_sparsity_sweep.py --condition sparsity_only --seeds 42 --max_lambda_steps 100

  # Full overnight run (5 seeds, sparsity_only):
  python scripts/HAM10000/run_sparsity_sweep.py --condition sparsity_only

  # Full overnight run (5 seeds, sparsity_concurvity):
  python scripts/HAM10000/run_sparsity_sweep.py --condition sparsity_concurvity
"""
...
OUT_ROOT               = "results/HAM10000/sparsity_sweep"
