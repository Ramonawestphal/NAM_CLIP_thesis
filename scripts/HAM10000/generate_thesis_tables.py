...
TABLE_DIR       = "results/HAM10000/thesis_tables"
OP_POINT_JSON   = "results/HAM10000/operating_point.json"
...
def _write_methodology_doc(main_rows: list, op_info: dict) -> None:
    """Write results/HAM10000/methodology.md."""
...
All results under `results/HAM10000/` were produced by scripts in `scripts/HAM10000/`,
...
point during selection.  Winner recorded in `results/HAM10000/architecture_search_cv/winner.json`.
