...
Issue 9 : Concurvity warm-up capability present; warmup_epochs=0 (no warm-up) is
           the default following the diagnostic in results/HAM10000/diagnostic_warmup/.
...
Output tree
───────────
  results/HAM10000/concurvity_sweep/
    lambda_{value}/
      seed_42/
        best_model.pt
        training_log.csv
...
──────────────────────────
  ...
  python scripts/HAM10000/run_concurvity_sweep.py --smoke_test   # lambda=0.0 only
"""
...
OUT_ROOT    = "results/HAM10000/concurvity_sweep"
