...
Reads results from:
  results/v7/diagnostic_warmup/warmup_0/   (SETTING A — no warm-up)
  results/v7/diagnostic_warmup/warmup_5/   (SETTING B — 5-epoch warm-up, v7 default)
  results/v7/diagnostic_warmup/warmup_2/   (SETTING C — 2-epoch warm-up)

Writes:
  results/v7/diagnostic_warmup/comparison.md

Usage (from project root):
    python scripts/v7/diagnostic_warmup_report.py
"""
...
SETTINGS = {
    "A (warmup=0)": "results/v7/diagnostic_warmup/warmup_0",
    "B (warmup=5)": "results/v7/diagnostic_warmup/warmup_5",
    "C (warmup=2)": "results/v7/diagnostic_warmup/warmup_2",
}
SEEDS     = [42, 43, 44, 45, 46]
OUT_DIR   = "results/v7/diagnostic_warmup"
OUT_MD    = "results/v7/diagnostic_warmup/comparison.md"
