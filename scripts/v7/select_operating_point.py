...
──────────────
  ...
  6. Write the selected lambda to results/v7/operating_point.json.

Usage (from project root)
──────────────────────────
  python scripts/v7/select_operating_point.py
  python scripts/v7/select_operating_point.py --path_csv results/v7/sparsity_sweep/path_seed42.csv
"""
...
DEFAULT_PATH_CSV   = "results/v7/sparsity_sweep/path_seed42.csv"
DEFAULT_DENSE_JSON = "results/v7/sparsity_sweep/seed_42/dense_seed42_conc1p0_ep100.json"
OUT_JSON           = "results/v7/operating_point.json"
...
def main() -> None:
    ...
    parser.add_argument("--sweep_root", type=str, default="results/v7/sparsity_sweep",
