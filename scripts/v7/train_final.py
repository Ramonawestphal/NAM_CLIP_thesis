...
Issue 9   : Concurvity warm-up capability added; default set to warmup_epochs=0
             (diagnostic experiment results/v7/diagnostic_warmup/comparison.md
...
──────────────────────────
  python scripts/v7/train_final.py --condition plain_nam
  python scripts/v7/train_final.py --condition concurvity_only --concurvity_lambda 1.0
  python scripts/v7/train_final.py --condition sparsity_only   --sparsity_lambda 23.7
  python scripts/v7/train_final.py --condition sparsity_conc   --concurvity_lambda 1.0 \\
...
WARMUP_EPOCHS = 0   # diagnostic (results/v7/diagnostic_warmup/) confirmed Setting A is optimal
