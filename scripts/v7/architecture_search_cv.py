...
Output
──────
results/v7/architecture_search_cv/
...
─────────────────────────
    python scripts/v7/architecture_search_cv.py
    python scripts/v7/architecture_search_cv.py --smoke_test   # config 1 only
    python scripts/v7/architecture_search_cv.py --max_epochs 20  # fast sanity run
"""
...
SCHED_PATIENCE = 5
SCHED_FACTOR   = 0.5
OUT_DIR      = "results/v7/architecture_search_cv"
...
def _run(args: argparse.Namespace, max_epochs: int, out_dir: str) -> None:
    ...
    if not args.smoke_test:
        ...
        print(f"\nSTEP 1 COMPLETE. Run scripts/v7/verify_no_leakage.py next.")
    else:
