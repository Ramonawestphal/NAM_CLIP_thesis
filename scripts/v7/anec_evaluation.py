...
Outputs:
  results/v7/anec_evaluation/by_seed.csv
  results/v7/anec_evaluation/aggregated.csv
  results/v7/anec_evaluation/summary_table.md
  results/v7/anec_evaluation/rule_a_secondary.md
  results/v7/anec_evaluation/methodology.md
...
SWEEP_BASE   = "results/v7/sparsity_sweep"
WINNER_JSON  = "results/v7/architecture_search_cv/winner.json"
OUT_DIR      = "results/v7/anec_evaluation"
